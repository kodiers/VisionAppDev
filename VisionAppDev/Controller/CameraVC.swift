    ...
    func resultsMethod(request: VNRequest, error: Error?) {
        ...
        for classification in results {
            if classification.confidence < 0.5 {
                ...
                let indetification = classification.identifier
                let confidence = Int(classification.confidence * 100)
                identificationLbl.text = indetification
                confidenceLbl.text = "CONFIDENCE \(confidence)%"
                let completeSentence = "This looks like \(indetification) and I'm \(confidence) percent sure"
